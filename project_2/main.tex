...
In this project, we aim to solve a \textit{compartmental modelling} problem proposed in \cite[pp.~313--314]{Kent_Nagle2018-ig}. The problem involves estimating the time it would take to clean up the Great Lakes (figure) of pollutants at varying levels of accuracy.
...
Figure~\ref{fig:pollution_decay} illustrates the reduction (\emph{decay}) of pollution in each of the Great Lakes over time, assuming clean water inflow. The plot was generated using the \texttt{matplotlib} library in Python.
