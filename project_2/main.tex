...
\begin{itemize}
    ...
    \item \(C(t)\) - concentration of pollutant in the lake at time \(t\) ($\unit{\kilo\gram / \kilo\cubic\meter}$) (mass per unit volume = $\frac{y(t)}{V}$)
...
\end{gather*}
From point a) we know the computations of $\frac{V}{r}$, which in here we can denote as \(\tau\). In this manner, the final form  of our equation becomes:
\begin{equation}
    y(t) = y_0 e^{-\frac{t}{\tau}}
